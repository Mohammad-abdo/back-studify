...
- General API: 100 requests per 15 minutes.
    ...
    tags: [
      ...
      { name: 'Content', description: 'Materials, reviews, and content pricing' },
      ...
      { name: 'Access Control', description: 'Roles, permissions, and user-role mappings' },
      ...
      { name: 'Mobile', description: 'Mobile-optimized endpoints by client type' },
      { name: 'Docs', description: 'Swagger and Postman documentation endpoints' },
